    ...
    <>
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 15% 20%, rgba(200,100,74,0.20), transparent 45%), radial-gradient(circle at 85% 15%, rgba(65,105,225,0.12), transparent 40%), radial-gradient(circle 1.5px, rgba(242,235,221,0.10) 1.5px, transparent 1.5px)",
      ...
      <div className="border-y border-ink/10 bg-paper px-6 py-12 text-center sm:py-16">
        <Reveal>
          ...
          <div className="mt-6">
            <Link
              href="/contacto"
              className="inline-flex items-center gap-2 rounded-lg bg-accent2 px-6 py-4 text-sm font-semibold uppercase tracking-wide text-ink transition hover:-translate-y-0.5 hover:opacity-90 hover:shadow-lg"
            >
