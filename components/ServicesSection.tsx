                ...
                <article className="flex h-full flex-col rounded-2xl border border-ink/10 bg-surface p-8 transition duration-300 hover:-translate-y-1.5 hover:shadow-xl">
                  ...
                  <div className="mt-8">
                    <ServiceCta
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-gold px-5 py-3 text-xs font-semibold uppercase tracking-wide text-paper transition hover:opacity-90"
                    />
